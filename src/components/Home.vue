<template>
    ...
    <v-container fluid class="text-center">
        <v-row class="ma-5">
            <v-col cols="12" lg="5">
                <v-sheet class="ma-5 pt-16 bg-transparent">
    ...
    <v-sheet class="bg-accent text-center">
        <v-sheet class="bg-transparent mx-auto px-5 py-16" max-width="900">
    ...
    <v-sheet class="mx-auto px-5 py-16 bg-transparent text-center" max-width="900">
    ...
    <v-sheet class="bg-accent text-center">
        <v-sheet class="bg-transparent mx-auto px-5 py-16" max-width="900">
            ...
            <h2 class="font-weight-light">All of your data is encrypted end to end, and will never be shared or sold.</h2>
        </v-sheet>
    </v-sheet>
</template>
