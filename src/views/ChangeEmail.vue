<template>
    <v-card class="pa-10 mx-auto mt-10 text-center" width="330">
        ...
        <v-text-field variant="underlined" class="my-4" label="New Email" v-model="email" :error="error"></v-text-field>
        <v-text-field variant="underlined" class="mb-4" label="Confirm New Email" v-model="confirmEmail" :error="error" @keyup.enter="changeEmail"></v-text-field>
