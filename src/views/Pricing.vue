        ...
        <v-row class="justify-center ma-0">
            <v-col cols="12" md="4" lg="3" class="mx-4 mb-16 mt-n16">
                <v-card elevation="10" width="330" class="py-16 mx-auto bg-secondary">
                    ...
                    <v-btn class="bg-primary elevation-4" width="200" size="large" variant="text" rounded="0" @click="redirect('month')">Start Free Trial</v-btn>
                </v-card>
            </v-col>
            ...
            <v-col cols="12" md="4" lg="3" class="mx-4 mb-16 mt-n16">
                <v-card elevation="10" width="330" class="py-16 mx-auto bg-secondary">
                    ...
                    <v-btn class="bg-primary elevation-4" width="200" size="large" variant="text" rounded="0" @click="redirect('year')">Start Free Trial</v-btn>
                </v-card>
            </v-col>
        </v-row>
    </v-sheet>
